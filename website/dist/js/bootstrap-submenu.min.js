...
(function(factory) {
  ...
  Submenupicker.prototype = {
    init: function() {
      this.$element.on('mouseenter.bs.dropdown', this.mouseenter.bind(this));
      this.$element.on('mouseleave.bs.dropdown', this.mouseleave.bind(this));
